...
#
# Just: "${PATH_TO_BINARY}/rodcontrol --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	try:
		...
		try:
			...
			camerargbdsimple_proxy = CameraRGBDSimplePrx.uncheckedCast(basePrx)
