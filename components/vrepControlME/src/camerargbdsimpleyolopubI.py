...
for p in icePaths:
	print('Trying', p, 'to load CameraRGBDSimpleYoloPub.ice')
	if os.path.isfile(p+'/CameraRGBDSimpleYoloPub.ice'):
		print('Using', p, 'to load CameraRGBDSimpleYoloPub.ice')
...
if not ice_CameraRGBDSimpleYoloPub:
	print('Couldn\'t load CameraRGBDSimpleYoloPub')
	sys.exit(-1)
from RoboCompCameraRGBDSimpleYoloPub import *

class CameraRGBDSimpleYoloPubI(CameraRGBDSimpleYoloPub):
