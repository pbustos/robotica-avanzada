...
/** \mainpage RoboComp::camerayolocppvrep
 *
 * \section intro_sec Introduction
 *
 * The camerayolocppvrep component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/camerayolocppvrep --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class camerayolocppvrep : public RoboComp::Application
{
public:
	camerayolocppvrep (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::camerayolocppvrep::initialize()
{
...
int ::camerayolocppvrep::run(int argc, char* argv[])
{
